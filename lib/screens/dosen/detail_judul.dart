  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "Detail Judul",
          style: TextStyle(color: Color.fromARGB(255, 255, 255, 255)), // Warna teks hitam
        ),
        backgroundColor: const Color.fromARGB(255, 0, 0, 0), // Warna latar belakang AppBar
        iconTheme: const IconThemeData(color: Colors.black), // Ikon hitam
        leading: IconButton(
          icon: const Icon(Icons.arrow_back, color: Color.fromARGB(255, 255, 255, 255)), // Tombol kembali warna hitam
          onPressed: () {
            ...
            children: [
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      // Judul Penelitian
                      _buildDetailInfo("Judul Penelitian", "Pengembangan Sistem Informasi Pengajuan Judul Skripsi"),
                      const SizedBox(height: 16),

                      // Objek Penelitian
                      _buildDetailInfo("Objek Penelitian", "Mahasiswa Informatika Semester Akhir"),
                      const SizedBox(height: 16),
              ...
              Row(
                ...
                children: [
                  ElevatedButton(
                    onPressed: () {
                      // Logika untuk menerima pengajuan judul
                      showDialog(
                        context: context,
                        builder: (context) => AlertDialog(
                          title: const Text("Konfirmasi", style: TextStyle(color: Colors.black)),
                          content: const Text("Apakah Anda yakin ingin menerima judul ini?", style: TextStyle(color: Colors.black)),
                          actions: [
                            TextButton(
                            ...
                            TextButton(
                              onPressed: () {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(content: Text("Judul berhasil diterima!", style: TextStyle(color: Color.fromARGB(255, 255, 255, 255)))),
                                );
                              },
                              child: const Text("Terima", style: TextStyle(color: Colors.black)),
                            ),
                          ],
                        ),
                      );
                  ...
                  ElevatedButton(
                    onPressed: () {
                      // Logika untuk menolak pengajuan judul
                      showDialog(
                        context: context,
                        builder: (context) => AlertDialog(
                          title: const Text("Konfirmasi", style: TextStyle(color: Colors.black)),
                          content: const Text("Apakah Anda yakin ingin menolak judul ini?", style: TextStyle(color: Colors.black)),
                          actions: [
                            TextButton(
                              onPressed: () => Navigator.pop(context),
                              child: const Text("Batal", style: TextStyle(color: Colors.black)),
                            ...
                            TextButton(
                              onPressed: () {
                                Navigator.pop(context);
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(content: Text("Judul berhasil ditolak!", style: TextStyle(color: Color.fromARGB(255, 255, 255, 255)))),
                                );
                              },
